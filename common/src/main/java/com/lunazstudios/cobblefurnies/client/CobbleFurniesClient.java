...
import com.lunazstudios.cobblefurnies.client.renderer.block.UpperCabinetBlockRenderer;
...
public class CobbleFurniesClient {
    ...
    public static void init() {
        ...
        CFRegistry.registerBlockEntityRenderer(CFBlockEntityTypes.UPPER_CABINET, UpperCabinetBlockRenderer::new);
    }
}
