...
public class SeatBlock extends Block {
    ...
    public static boolean isSeatBlocked(Level level, BlockPos pos) {
        return !(level.getBlockState(pos.above()).getCollisionShape(level, pos).isEmpty() ||
                level.getBlockState(pos.above()).is(CFBlockTags.ABOVE_BYPASSES_SEAT_CHECK));
    }
    ...
    public static boolean canBePickedUp(Entity passenger) {
        ...
        return passenger instanceof LivingEntity && passenger.getType().is(CFEntityTypeTags.CAN_SIT_IN_SEATS);
    }
